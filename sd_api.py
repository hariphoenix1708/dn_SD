...
async def inpaint(image: bytes, mask: bytes) -> bytes:
    ...
    async with httpx.AsyncClient(timeout=None) as client:
        r = await client.post(
            ...
            "https://7faa-34-32-133-227.ngrok.io/sdapi/v1/img2img",
            json={
                "init_images": [image],
                "resize_mode": "1",
                ...
                "mask": mask,
                "mask_blur": 8,
                "prompt": "(make her nude, completely nude), sexy girl, perfect sexy breast, intricate skin texture, (goosebumps:1.3)",
                ...
                "negative_prompt": "(deformed, deformed body, deformed breasts, distorted, disfigured:1.3), poorly drawn, bad anatomy, wrong anatomy, extra limb, missing limb, floating limbs, (mutated hands and fingers:1.4), disconnected limbs, mutation, mutated, ugly, disgusting, blurry, amputation",
                "steps": 20,
