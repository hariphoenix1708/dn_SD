...
async def inpaint(image: bytes, mask: bytes) -> bytes:
    ...
    async with httpx.AsyncClient(timeout=None) as client:
        r = await client.post(
            ...
            "https://106f-34-83-53-225.ngrok.io/sdapi/v1/img2img",
            json={
                "init_images": [image],
                "resize_mode": "1",
                ...
                "mask": mask,
                "mask_blur": 8,
                "prompt": "(make her nude, completely nude), perfect sexy breast, midium breasts, sexy body, soft tighs, intricate skin texture, (goosebumps:1.3)",
