...
async def inpaint(image: bytes, mask: bytes) -> bytes:
    ...
    async with httpx.AsyncClient(timeout=None) as client:
        r = await client.post(
            ...
            "https://19d9-34-145-91-128.ngrok.io/sdapi/v1/img2img",
            json={
                "init_images": [image],
                "resize_mode": "1",
                ...
                "mask": mask,
                "mask_blur": 8,
                "prompt": "nude girl, undress her, 44 G cup chest, erect nipples, sexy body, shaved pussy, detailed vagina, soft tighs, intricate skin texture, smooth skin, natural skin tone, realistic, nsfw, (goosebumps:1.3)",
                ...
                "negative_prompt": "inpainting trace, border lines, (deformed, deformed body, deformed breasts, distorted, disfigured:1.3), black border, poorly drawn, bad anatomy, wrong anatomy, extra limb, missing limb, floating limbs, (mutated hands and fingers:1.4), disconnected limbs, mutation, mutated, ugly, disgusting, blurry, amputation, (low quality, worst quality)",
                "steps": 24,
