    ...
    async with httpx.AsyncClient(timeout=None) as client:
        r = await client.post(
            ...
            json={
                ...
                "mask": mask,
                "mask_blur": 8,
                "prompt": "nude girl below face, 44 G cup chest, erect nipples, sexy body, shaved pussy, detailed vagina, soft tighs, intricate skin texture, smooth skin, natural skin tone, realistic, masterpiece, nsfw, (goosebumps:1.3)",
