...
async def inpaint(image: bytes, mask: bytes) -> bytes:
    ...
    async with httpx.AsyncClient(timeout=None) as client:
        r = await client.post(
            ...
            "https://7abb-34-82-148-163.ngrok.io/sdapi/v1/img2img",
            json={
                "init_images": [image],
                "resize_mode": "1",
                ...
                "mask": mask,
                "mask_blur": 8,
                "prompt": "naked girl, bare naked, (make her nude, completely nude), nude girl, perfect sexy breast, medium breasts, erect nipples, highly detailed breasts, sexy body, shaved pussy, detailed vagina, soft tighs, intricate skin texture, smooth skin, natural skin texture, realistic, masterpiece, nsfw, (goosebumps:1.3)",
                ...
                "negative_prompt": "face, (deformed, deformed body, deformed breasts, distorted, disfigured:1.3), black border, poorly drawn, bad anatomy, wrong anatomy, extra limb, missing limb, floating limbs, (mutated hands and fingers:1.4), disconnected limbs, mutation, mutated, ugly, disgusting, blurry, amputation, (low quality, worst quality), EasyNegativeV2, saree, sari",
                "steps": 24,
