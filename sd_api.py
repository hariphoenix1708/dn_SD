...
async def inpaint(image: bytes, mask: bytes) -> bytes:
    ...
    async with httpx.AsyncClient(timeout=None) as client:
        r = await client.post(
            ...
            "https://2774-34-136-168-188.ngrok.io/sdapi/v1/img2img",
            json={
                "init_images": [image],
                "resize_mode": "1",
                ...
                "mask": mask,
                "mask_blur": 8,
                "prompt": "naked girl, bare naked, (make her nude, completely nude), nude girl, perfect sexy breast, midium breasts, erect nipples, highly detailed breasts, sexy body, shaved pussy, detailed vagina, soft tighs, intricate skin texture, smooth skin, natural glow, realistic, masterpiece, nsfw, (goosebumps:1.3)",
